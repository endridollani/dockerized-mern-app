...
const desc = "The 207 was based on a modified versasdasda sdasdasd ion of the platform used for the Citroën C3 and was built in Poissy (France), Madrid (Spain) and a new plant in Trnava, Slovakia.";
const nm = "Peugeot 207 Hatchback 2008";

interface CarStripeMobileProps {
    onViewDetailsCallback: (carId: string) => void;
}

const CarStripeMobile: React.FC<CarStripeMobileProps & CarStripeProps> = 
...
export default CarStripeMobile;